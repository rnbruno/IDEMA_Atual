...
function cm_makeObj(obj,name,level,win,nest,o){
	...
	else this.evnt=bw.dom?win.document.getElementById(obj):bw.ie4?win.document.getElementById[obj]:bw.ns4?nest?win.document[nest].document[obj]:win.document[obj]:0;
...
this.css.clip="rect("+t+"px,"+r+"px,"+b+"px,"+l+"px)"; if(w){this.css.width=r; this.css.height=b}}; this.width=r; this.height=b}
