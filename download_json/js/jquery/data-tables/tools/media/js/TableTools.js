...
var TableToolsInit = {
	...
	"sPrintInfo": "<h6>Visualiza&ccedil;&atilde;o de impress&atilde;o</h6><p>Por favor, use a fun&ccedil;&atilde;o do seu navegador para "+
		"imprimir essa tabela. Aperte ESC para sair.", /* The 'fading' message */
	"sTitle": "",
...
function TableTools ( oInit )
{
	...
	function fnFeatureSaveCSV ()
	{
		...
		fnGlue( clip, nButton, "ToolTables_CSV_"+_iId, "Salvar como arquivo CSV" );
	}
	...
	function fnFeatureSaveXLS ()
	{
		...
		fnGlue( clip, nButton, "ToolTables_XLS_"+_iId, "Salvar como arquivo do Excel(xls)" );
	}
	...
	function fnFeatureClipboard ()
	{
		...
		clip.addEventListener('complete', function (client, text) {
			...
			alert( (aData.length-1)+' linhas copiadas para a área de transferência.' );
		} );
		
		fnGlue( clip, nButton, "ToolTables_Copy_"+_iId, "Copiar para a área de transferência." );
	}
